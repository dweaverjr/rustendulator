...
pub(super) const OPCODE_TABLE: [OpcodeRecord; 177] = [
    ...
    /* 0xBC */ opcode("LDY", Cpu::ldy, 4, AddressingMode::AbsoluteY, true),
    /* 0xBD */ opcode("LDA", Cpu::lda, 4, AddressingMode::AbsoluteY, true),
    ...
    /* 0xD5 */ opcode("CMP", Cpu::cmp, 3, AddressingMode::ZeroPage, false),
    /* 0xD6 */ opcode("DEC", Cpu::dec, 5, AddressingMode::ZeroPage, false),
    /* 0xD7 */ opcode("DCP", Cpu::dcp, 5, AddressingMode::ZeroPage, false),
];
