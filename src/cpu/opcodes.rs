...
pub(super) const OPCODE_TABLE: [OpcodeRecord; 128] = [
    ...
    /* 0x32 */ opcode("KIL", Cpu::kil, 0, AddressingMode::Implicit, false),
    ...
    /* 0x42 */ opcode("KIL", Cpu::kil, 0, AddressingMode::Implicit, false),
    ...
    /* 0x48 */ opcode("PHA", Cpu::pha, 3, AddressingMode::ZeroPage, false),
    ...
    /* 0x52 */ opcode("KIL", Cpu::kil, 0, AddressingMode::Implicit, false),
    ...
    /* 0x62 */ opcode("KIL", Cpu::kil, 0, AddressingMode::Implicit, false),
    ...
    /* 0x72 */ opcode("KIL", Cpu::kil, 0, AddressingMode::Implicit, false),
